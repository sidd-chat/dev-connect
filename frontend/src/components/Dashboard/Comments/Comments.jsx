  ...
  return (
    <>
      ...
      {toggleCommentsModal && (
        ...
        <div className={`${toggleCommentsModal ? "w-[30%]" : "w-0"} transition-all duration-300 fixed z-10 top-0 right-0 w-[30%] h-screen bg-black p-10 flex flex-col`}>
          <div className='grow-1'>
            ...
            <CommentsFeed snippetId={snippetId} />
          </div>
